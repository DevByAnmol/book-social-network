package com.anmol.book.book;

import com.anmol.book.common.PageResponse;
import com.anmol.book.exception.OperationNotPermittedException;
import com.anmol.book.file.FileStorageService;
import com.anmol.book.history.BookTransactionHistory;
import com.anmol.book.history.BookTransactionHistoryRepository;
import com.anmol.book.user.User;
...
import static com.anmol.book.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public Integer approveReturnedBorrowedBook(Integer bookId, Authentication connectedUser) {
        ...
        BookTransactionHistory bookTransactionHistory = transactionHistoryRepository.findByBookIdAndOwnerId(bookId, user.getId())
                .orElseThrow(() -> new OperationNotPermittedException("The book is not return yet. You cannot approve its return"));
